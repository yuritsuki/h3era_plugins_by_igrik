...
int __cdecl Y_Dlg_WoGMessage(HiHook* hook, char* Msg1, char* Msg2, char* Msg3, char* Msg4, char* Msg5)
{
    std::string message;
...
void __cdecl Y_WoG_PicDlg_Pcx8(HiHook* hook, char* Msg1, char* Pic)
{
    if ( !Pic )
        Pic = "default.pcx";
...
void __cdecl Y_WoG_PicDlg_Def(HiHook* hook, char* Msg1, char* DefName)
{
    if ( !DefName )
        DefName = "CH00.def";
