...
//  char ShowIntro;            // показывать/нет интро};
  ...
  int GetListener(int Type, int Page, int ItemList, int Item) {return CALL_4(int, __cdecl, 0x7775EC, Type, Page, ItemList, Item); }
};
...
struct _ChooseFile_ 
{
  ...
  */
  ...
  // int   Flags;            // резерв
  char* fileName;        // название файла по умолчанию (опционально)
  };
//================================================= // Dialogue12
